...
```
docker run --rm --env CYPRESS_baseUrl=http://nginx:80 -v ${PWD}:/cypress -w /cypress --network="lsocial-template_default" -it vcaballerosalle/cypress-mysql:1.0 /cypress --browser chrome --spec "cypress/integration/sign-up.spec.js"
```
